...
export const SENTINEL_OPERATIONAL_COUNTER_KEYS = new Set([
  ...
  "vault.disclosure.grant.created_total",
  "vault.disclosure.access.failed_acceptance_total",
  "vault.disclosure.access.failed_verify_total",
  "vault.disclosure.access.revoked_attempt_total",
  "vault.disclosure.access.expired_attempt_total",
  "vault.disclosure.access.repeated_recipient_total",
  ...
  "vault.disclosure.access.rate_limited_total",
  "vault.disclosure.receipt.verify_success_total",
  "vault.disclosure.receipt.verify_denied_total",
  "vault.disclosure.receipt.verify_integrity_failed_total",
  "vault.disclosure.receipt.verify_rate_limited_total",
