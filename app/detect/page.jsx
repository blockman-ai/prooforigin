...
export default function DetectPage() {
  ...
  try {
    ...
    setPreview("");
    setError("Image selected, but HEIC preview could not be generated.");
  }
  }
  ...
  async function analyzeImage(e) {
    ...
    try {
      ...
      try {
        ...
        setError(PROXY_UNREACHABLE);
        setLoading(false);
        return;
      }

      if (!res.ok || proxyData.success === false) {
        setError(proxyData.error || "Analysis failed.");
        setLoading(false);
        return;
      }

      const data = proxyData.raw ?? proxyData;
