...
test("migration planning rejects compromised source document", async (t) => {
    ...
    exports: {
      ...
      getVaultDocumentById: async () => ({
        document: {
          ...
          vault_id: VAULT_ID,
          deleted_at: null,
          compromised_at: "2026-06-14T18:40:00.000Z",
        },
        error: null,
      }),
  ...
  assert.equal(json.code, "SOURCE_DOCUMENT_COMPROMISED");
